...
export default function AdminTerms() {
  ...
  function load() {
    adminFetch('/api/terms/terms.php')
      .then(r => r.json())
  ...
  async function handleAdd() {
    ...
    setSaving(true);
    const res = await adminFetch('/api/terms/terms.php', { method:'POST', body: newTerm });
  ...
  async function handleEdit() {
    ...
    setSaving(true);
    const res = await adminFetch('/api/terms/terms.php', { method:'PUT', body: editing });
    const d   = await res.json();
    setSaving(false);
